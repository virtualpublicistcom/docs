...
<html lang="en">
    <head>
        ...
        <meta property="og:image" content=<?php echo e($page->baseUrl); ?>/assets/img/logo.png"/>
    ...
    <body class="flex flex-col justify-between min-h-screen bg-gray-100 text-gray-800 leading-normal font-sans">
        <header class="flex items-center shadow bg-white border-b h-18 mb-8 py-4" role="banner">
            <div class="container flex items-center max-w-8xl mx-auto px-4 lg:px-8">
                <div class="flex items-center">
                    <a href="<?php echo e($page->baseUrl); ?>" title="<?php echo e($page->siteName); ?> home" class="inline-flex items-center">
                        <img class="h-6 md:h-8 mr-3" src="<?php echo e($page->baseUrl); ?>/assets/img/vp-logo.svg" alt="<?php echo e($page->siteName); ?> logo" />
                        <h1 class="text-lg md:text-2xl text-blue-900 font-semibold hover:text-blue-600 my-0 mt-1 pr-4"></h1>
                    </a>
                </div>
        ...
        <footer class="bg-white text-center text-sm mt-12 py-4" role="contentinfo">
            <ul class="flex flex-col md:flex-row justify-center">
                <li class="md:mr-2">
                    &copy; <a href="https://virtualpublicist.com" title="Tighten website">Virtual Publicist</a> <?php echo e(date('Y')); ?>.
                </li>
...
<?php /**PATH /Users/raffi/Projects/inexxus/docs/source/_layouts/master.blade.php ENDPATH**/ ?>